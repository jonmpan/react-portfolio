const portfolioObjects = [
	{
		img:"/assets/img/p-quizit.png",
		title:"QuizIt!",
		description:"QuizIt is a live, multiplayer trivia game. Utilizing socket.io and MERN, QuizIt ensures that all users are seeing the same question and playing at the same time!",
	...
	},
	{
		...
		description:"This portfolio site is also a portfolio piece! It is pointlessly built with a full MERN stack. Perhaps I will add some server/client functionality to this site later.",
	...
	},
	{
		...
		title:"Closets x3",
		description:"Closets Closets Closets is an MVC site where you can post items you may own. The authentication system for this site was never completed but you can still make a snazzy collection.",
