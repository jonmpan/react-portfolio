    ...
    return (
      <div className="privacyContainer">
        ...
        <p>
          ...
          jonmpan is created with the help of the{" "}
        ...
        <p>jonmpan uses the collected data for various purposes:</p>
        <ul>
        ...
        <p>
          jonmpan will take all steps reasonably necessary to ensure that your
        ...
        <p>
          jonmpan may disclose your Personal Data in the good faith belief that
          such action is necessary to:
        </p>
        <ul>
          <li>To comply with a legal obligation</li>
          <li>To protect and defend the rights or property of jonmpan</li>
          <li>
        ...
        <ul>
          <li>
            ...
            <p>
              dashbot is a web analytics service. Read the Privacy Policy for
              dashbot here:{" "}
              <a href="https://www.dashbot.io/">
                https://www.dashbot.io/legal/tos
              </a>
            </p>
          </li>
        </ul>
        ...
        <ul>
          <li>By email: jonmpan@jonmpan.com</li>
        </ul>
      </div>
    );
  }
