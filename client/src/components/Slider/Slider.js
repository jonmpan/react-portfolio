	...
	render(){
		return(
			<section id="home" className="slider fullscreen scrollspy">
				<ul className="slides">
					<li>
						<img src="/assets/img/background1-compressed.jpg" alt="Photo by Noah Erickson from Pexels" />
					...
					<li>
						<img src="/assets/img/background2-compressed.jpg" alt="Photo by Lorenzo Cafaro from Pexels" />
						<div className="caption left-align">
							<h3 className="black-text">I work with <strong className="red-text darken-text-4">&quot;Most&quot;</strong> budgets.</h3>
							<h5 className="white-text  hide-on-small-only">I hate being picky but I do need to pay mortgage and eat. If you want quality work for a cheapish price, hit me up!</h5>
						</div>
					</li>
					<li>
